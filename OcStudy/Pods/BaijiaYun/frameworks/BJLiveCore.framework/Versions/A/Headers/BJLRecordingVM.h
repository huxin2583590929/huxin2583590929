...
/**
老师/助教: 设置所有开启视频的用户的推流镜像模式,  只对webrtc专业小班课有效
...
/**
老师/助教: 设置指定用户的推流镜像模式,  只对webrtc专业小班课有效
#param mode BJLEncoderMirrorMode 翻转的类型
#param user 对象用户，只能是老师或者助教
#return BJLError:
BJLErrorCode_invalidUserRole   错误权限，要求老师或助教权限
...
/**
老师/助教: 获取指定用户的推流镜像模式,  只对webrtc专业小班课有效
...
/** 获取外接移动端设备作为摄像头的参数链接，生成链接后将在外接设备进教室，然后退出之后失效 */
