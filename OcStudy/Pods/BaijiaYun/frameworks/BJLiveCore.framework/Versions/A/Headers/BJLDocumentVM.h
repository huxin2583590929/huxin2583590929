...
/** 所有参加作答小黑板的用户 */
@property (nonatomic, readonly, copy, nullable) NSArray<BJLUser *> *allWritingBoardParticipatedUsers;

/** 所有已提交小黑板的用户 */
@property (nonatomic, readonly, copy, nullable) NSArray<BJLUser *> *allWritingBoardSubmitedUsers;
...
/**
 ...
 #param writingBoard 小黑板信息, 此时 writingBoard 的 `submitedUsers` 和 `participatedUsers` 为空,此处不做统计
 */
- (BJLObservable)didSubmitWritingBoard:(BJLWritingBoard *)writingBoard;
...
/**
 ...
 #param writingBoard 小黑板信息, 此时 writingBoard 的 `submitedUsers` 和 `participatedUsers` 为空,此处不做统计
 */
- (BJLObservable)didParticipateWritingBoard:(BJLWritingBoard *)writingBoard;

/**
 拉取小黑板状态
 #param boardID 小黑板ID, 为空则获取当前教室的小黑板信息, 否则获取指定boardID信息
 */
